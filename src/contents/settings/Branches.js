...
const reportTitle = "Branches";
const EntityName = 'Branch';
const url = process.env.REACT_APP_BRANCHES_URL;
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="center" style={{ whiteSpace: 'nowrap' }}>
                                                        ...
                                                        <IconButton style={inlineStyles.iconButton} onClick={() => this.confirmDeleteRow(row.id, row.branchname)} aria-label="Delete row">
