...
$userFields = "name,description";
$defaultOrder = 'name';
switch($_REQUEST['action']) {
    case 'schema':
        $schema = [
        ['name'=>'name', 'label'=>'Name', 'required'=>true, 'value'=>'', 'error'=>'', 'numeric'=>false, 'showInList'=>true, 'type'=>'text', 'gridsize'=>12],
        ['name'=>'description', 'label'=>'Description', 'required'=>false, 'value'=>'', 'error'=>'', 'numeric'=>false, 'showInList'=>true, 'type'=>'text', 'gridsize'=>12]
